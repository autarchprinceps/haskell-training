...
tescombination combination = test (onion (keyvalue [] 'k' lrs) (map (keyvalue [] 'k') combination)) (onion (keyvalue [] 'g' lrs) (map (keyvalue [] 'g') combination)) (onion (keyvalue [] 'h' lrs) (map (keyvalue [] 'h') combination))
